...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
return((...e)=>e.map((e=>(e=>e?"string"==typeof e?e:e.source:null)(e))).join(""))("(",e,")?")
}return t=>{const n=(t=>{const n=t.COMMENT("//","$",{contains:[{begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+e(r)+"[a-zA-Z_]\\w*"+e("<[^<>]+>")+")",s={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},i={className:"string",
...
;return n.name="C",n.aliases=["c","h"],n}})());hljs.registerLanguage("less",(()=>{"use strict";return e=>{
...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
},relevance:0}]})})());hljs.registerLanguage("perl",(()=>{"use strict";function e(...e){
...
aliases:["pl","pm"],keywords:s,contains:c}}})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
...
contains:[n.SHEBANG({binary:"ruby"})].concat(E).concat(t).concat(_)}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
subLanguage:"bash"}}]})})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
